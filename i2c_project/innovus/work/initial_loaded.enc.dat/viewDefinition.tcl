...
create_library_set -name Max\
   -timing\
    [list ${::IMEX::libVar}/mmmc/PIO320SL_ss_1p62v_1p62v_125c.lib\
    ${::IMEX::libVar}/mmmc/tsl18fs190svt_ss_1p62v_125c.lib]
create_library_set -name Typ\
   -timing\
    [list ${::IMEX::libVar}/mmmc/PIO320SL_tt_1p8v_1p8v_25c.lib\
    ${::IMEX::libVar}/mmmc/tsl18fs190svt_tt_1p8v_25c.lib]
create_library_set -name Min\
   -timing\
    [list ${::IMEX::libVar}/mmmc/PIO320SL_ff_1p98v_1p98v_m40c.lib\
    ${::IMEX::libVar}/mmmc/tsl18fs190svt_ff_1p98v_m40c.lib]
create_rc_corner -name SlowRC\
   -cap_table ${::IMEX::libVar}/mmmc/TSL601_6M1L.capTbl\
   -preRoute_res 1\
   -postRoute_res 1\
   -preRoute_cap 1\
   -postRoute_cap 1\
...
create_rc_corner -name FastRC\
   ...
   -preRoute_clkcap 0\
   -T -40\
   -qx_tech_file ${::IMEX::libVar}/mmmc/FastRC/qrcTechFile
